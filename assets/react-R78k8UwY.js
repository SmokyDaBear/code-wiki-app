...
\`\`\`
`,ae=`# Conditional Rendering in React
...
`,de={data:``},w=e=>{if(typeof window==`object`){let t=(e?e.querySelector(`#_goober`):window._goober)||Object.assign(document.createElement(`style`),{innerHTML:` `,id:`_goober`});return t.nonce=window.__nonce__,t.parentNode||(e||document.head).appendChild(t),t.firstChild}return e||de},T=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,fe=/\/\*[^]*?\*\/|  +/g,pe=/\n+/g,me=(e,t)=>{let n=``,r=``,i=``;for(let a in e){let o=e[a];a[0]==`@`?a[1]==`i`?n=a+` `+o+`;`:r+=a[1]==`f`?me(o,a):a+`{`+me(o,a[1]==`k`?``:t)+`}`:typeof o==`object`?r+=me(o,t?t.replace(/([^,])+/g,e=>a.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,t=>/&/.test(t)?t.replace(/&/g,e):e?e+` `+t:t)):a):o!=null&&(a=/^--/.test(a)?a:a.replace(/[A-Z]/g,`-$&`).toLowerCase(),i+=me.p?me.p(a,o):a+`:`+o+`;`)}return n+(t&&i?t+`{`+i+`}`:i)+r},E={},D=e=>{if(typeof e==`object`){let t=``;for(let n in e)t+=n+D(e[n]);return t}return e},O=(e,t,n,r,i)=>{let a=D(e),o=E[a]||(E[a]=(e=>{let t=0,n=11;for(;t<e.length;)n=101*n+e.charCodeAt(t++)>>>0;return`go`+n})(a));if(!E[o]){let t=a===e?(e=>{let t,n,r=[{}];for(;t=T.exec(e.replace(fe,``));)t[4]?r.shift():t[3]?(n=t[3].replace(pe,` `).trim(),r.unshift(r[0][n]=r[0][n]||{})):r[0][t[1]]=t[2].replace(pe,` `).trim();return r[0]})(e):e;E[o]=me(i?{[`@keyframes `+o]:t}:t,n?``:`.`+o)}let s=n&&E.g?E.g:null;return n&&(E.g=E[o]),((e,t,n,r)=>{r?t.data=t.data.replace(r,e):t.data.indexOf(e)===-1&&(t.data=n?e+t.data:t.data+e)})(E[o],t,r,s),o},he=(e,t,n)=>e.reduce((e,r,i)=>{let a=t[i];if(a&&a.call){let e=a(n),t=e&&e.props&&e.props.className||/^go/.test(e)&&e;a=t?`.`+t:e&&typeof e==`object`?e.props?``:me(e,``):!1===e?``:e}return e+r+(a??``)},``);function ge(e){let t=this||{},n=e.call?e(t.p):e;return O(n.unshift?n.raw?he(n,[].slice.call(arguments,1),t.p):n.reduce((e,n)=>Object.assign(e,n&&n.call?n(t.p):n),{}):n,w(t.target),t.g,t.o,t.k)}var _e,ve,ye;ge.bind({g:1});var be=ge.bind({k:1});function xe(e,t,n,r){me.p=t,_e=e,ve=n,ye=r}function Se(e,t){let n=this||{};return function(){let r=arguments;function i(a,o){let s=Object.assign({},a),c=s.className||i.className;n.p=Object.assign({theme:ve&&ve()},s),n.o=/ *go\d+/.test(c),s.className=ge.apply(n,r)+(c?` `+c:``),t&&(s.ref=o);let l=e;return e[0]&&(l=s.as||e,delete s.as),ye&&l[0]&&ye(s),_e(l,s)}return t?t(i):i}}var k=e(g(),1),Ce=e=>typeof e==`function`,we=(e,t)=>Ce(e)?e(t):e,Te=(()=>{let e=0;return()=>(++e).toString()})(),Ee=(()=>{let e;return()=>{if(e===void 0&&typeof window<`u`){let t=matchMedia(`(prefers-reduced-motion: reduce)`);e=!t||t.matches}return e}})(),De=20,Oe=`default`,ke=(e,t)=>{let{toastLimit:n}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,n)};case 1:return{...e,toasts:e.toasts.map(e=>e.id===t.toast.id?{...e,...t.toast}:e)};case 2:let{toast:r}=t;return ke(e,{type:e.toasts.find(e=>e.id===r.id)?1:0,toast:r});case 3:let{toastId:i}=t;return{...e,toasts:e.toasts.map(e=>e.id===i||i===void 0?{...e,dismissed:!0,visible:!1}:e)};case 4:return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(e=>e.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let a=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(e=>({...e,pauseDuration:e.pauseDuration+a}))}}},Ae=[],je={toasts:[],pausedAt:void 0,settings:{toastLimit:De}},Me={},Ne=(e,t=Oe)=>{Me[t]=ke(Me[t]||je,e),Ae.forEach(([e,n])=>{e===t&&n(Me[t])})},Pe=e=>Object.keys(Me).forEach(t=>Ne(e,t)),Fe=e=>Object.keys(Me).find(t=>Me[t].toasts.some(t=>t.id===e)),Ie=(e=Oe)=>t=>{Ne(t,e)},Le={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},Re=(e={},t=Oe)=>{let[n,r]=(0,k.useState)(Me[t]||je),i=(0,k.useRef)(Me[t]);(0,k.useEffect)(()=>(i.current!==Me[t]&&r(Me[t]),Ae.push([t,r]),()=>{let e=Ae.findIndex(([e])=>e===t);e>-1&&Ae.splice(e,1)}),[t]);let a=n.toasts.map(t=>({...e,...e[t.type],...t,removeDelay:t.removeDelay||e[t.type]?.removeDelay||e?.removeDelay,duration:t.duration||e[t.type]?.duration||e?.duration||Le[t.type],style:{...e.style,...e[t.type]?.style,...t.style}}));return{...n,toasts:a}},ze=(e,t=`blank`,n)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:`status`,"aria-live":`polite`},message:e,pauseDuration:0,...n,id:n?.id||Te()}),Be=e=>(t,n)=>{let r=ze(t,e,n);return Ie(r.toasterId||Fe(r.id))({type:2,toast:r}),r.id},A=(e,t)=>Be(`blank`)(e,t);A.error=Be(`error`),A.success=Be(`success`),A.loading=Be(`loading`),A.custom=Be(`custom`),A.dismiss=(e,t)=>{let n={type:3,toastId:e};t?Ie(t)(n):Pe(n)},A.dismissAll=e=>A.dismiss(void 0,e),A.remove=(e,t)=>{let n={type:4,toastId:e};t?Ie(t)(n):Pe(n)},A.removeAll=e=>A.remove(void 0,e),A.promise=(e,t,n)=>{let r=A.loading(t.loading,{...n,...n?.loading});return typeof e==`function`&&(e=e()),e.then(e=>{let i=t.success?we(t.success,e):void 0;return i?A.success(i,{id:r,...n,...n?.success}):A.dismiss(r),e}).catch(e=>{let i=t.error?we(t.error,e):void 0;i?A.error(i,{id:r,...n,...n?.error}):A.dismiss(r)}),e};var Ve=1e3,He=(e,t=`default`)=>{let{toasts:n,pausedAt:r}=Re(e,t),i=(0,k.useRef)(new Map).current,a=(0,k.useCallback)((e,t=Ve)=>{if(i.has(e))return;let n=setTimeout(()=>{i.delete(e),o({type:4,toastId:e})},t);i.set(e,n)},[]);(0,k.useEffect)(()=>{if(r)return;let e=Date.now(),i=n.map(n=>{if(n.duration===1/0)return;let r=(n.duration||0)+n.pauseDuration-(e-n.createdAt);if(r<0){n.visible&&A.dismiss(n.id);return}return setTimeout(()=>A.dismiss(n.id,t),r)});return()=>{i.forEach(e=>e&&clearTimeout(e))}},[n,r,t]);let o=(0,k.useCallback)(Ie(t),[t]),s=(0,k.useCallback)(()=>{o({type:5,time:Date.now()})},[o]),c=(0,k.useCallback)((e,t)=>{o({type:1,toast:{id:e,height:t}})},[o]),l=(0,k.useCallback)(()=>{r&&o({type:6,time:Date.now()})},[r,o]),u=(0,k.useCallback)((e,t)=>{let{reverseOrder:r=!1,gutter:i=8,defaultPosition:a}=t||{},o=n.filter(t=>(t.position||a)===(e.position||a)&&t.height),s=o.findIndex(t=>t.id===e.id),c=o.filter((e,t)=>t<s&&e.visible).length;return o.filter(e=>e.visible).slice(...r?[c+1]:[0,c]).reduce((e,t)=>e+(t.height||0)+i,0)},[n]);return(0,k.useEffect)(()=>{n.forEach(e=>{if(e.dismissed)a(e.id,e.removeDelay);else{let t=i.get(e.id);t&&(clearTimeout(t),i.delete(e.id))}})},[n,a]),{toasts:n,handlers:{updateHeight:c,startPause:s,endPause:l,calculateOffset:u}}},Ue=be`
from {
...
to {
  ...
  animation: ${et} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,nt=({toast:e})=>{let{icon:t,type:n,iconTheme:r}=e;return t===void 0?n===`blank`?null:k.createElement($e,null,k.createElement(Je,{...r}),n!==`loading`&&k.createElement(Qe,null,n===`error`?k.createElement(Ke,{...r}):k.createElement(Ze,{...r}))):typeof t==`string`?k.createElement(tt,null,t):t},rt=e=>`
0% {transform: translate3d(0,${e*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,it=e=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${e*-150}%,-1px) scale(.6); opacity:0;}
`,at=`0%{opacity:0;} 100%{opacity:1;}`,ot=`0%{opacity:1;} 100%{opacity:0;}`,st=Se(`div`)`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,lt=(e,t)=>{let n=e.includes(`top`)?1:-1,[r,i]=Ee()?[at,ot]:[rt(n),it(n)];return{animation:t?`${be(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${be(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},ut=k.memo(({toast:e,position:t,style:n,children:r})=>{let i=e.height?lt(e.position||t||`top-center`,e.visible):{opacity:0},a=k.createElement(nt,{toast:e}),o=k.createElement(ct,{...e.ariaProps},we(e.message,e));return k.createElement(st,{className:e.className,style:{...i,...n,...e.style}},typeof r==`function`?r({icon:a,message:o}):k.createElement(k.Fragment,null,a,o))});xe(k.createElement);var dt=({id:e,className:t,style:n,onHeightUpdate:r,children:i})=>{let a=k.useCallback(t=>{if(t){let n=()=>{let n=t.getBoundingClientRect().height;r(e,n)};n(),new MutationObserver(n).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,r]);return k.createElement(`div`,{ref:a,className:t,style:n},i)},ft=(e,t)=>{let n=e.includes(`top`),r=n?{top:0}:{bottom:0},i=e.includes(`center`)?{justifyContent:`center`}:e.includes(`right`)?{justifyContent:`flex-end`}:{};return{left:0,right:0,display:`flex`,position:`absolute`,transition:Ee()?void 0:`all 230ms cubic-bezier(.21,1.02,.73,1)`,transform:`translateY(${t*(n?1:-1)}px)`,...r,...i}},pt=ge`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,j=16,mt=({reverseOrder:e,position:t=`top-center`,toastOptions:n,gutter:r,children:i,toasterId:a,containerStyle:o,containerClassName:s})=>{let{toasts:c,handlers:l}=He(n,a);return k.createElement(`div`,{"data-rht-toaster":a||``,style:{position:`fixed`,zIndex:9999,top:j,left:j,right:j,bottom:j,pointerEvents:`none`,...o},className:s,onMouseEnter:l.startPause,onMouseLeave:l.endPause},c.map(n=>{let a=n.position||t,o=ft(a,l.calculateOffset(n,{reverseOrder:e,gutter:r,defaultPosition:t}));return k.createElement(dt,{id:n.id,key:n.id,onHeightUpdate:l.updateHeight,className:n.visible?pt:``,style:o},n.type===`custom`?we(n.message,n):i?i(n):k.createElement(ut,{toast:n,position:a}))}))},ht=A,gt=/^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,_t=/^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,vt={};function yt(e,t){return((t||vt).jsx?_t:gt).test(e)}var bt=/[ \t\n\f\r]/g;function xt(e){return typeof e==`object`?e.type===`text`?St(e.value):!1:St(e)}function St(e){return e.replace(bt,``)===``}var Ct=t(((e,t)=>{var n=/\/\*[^*]*\*+([^/*][^*]*\*+)*\//g,r=/\n/g,i=/^\s*/,a=/^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/,o=/^:\s*/,s=/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/,c=/^[;\s]*/,l=/^\s+|\s+$/g,u=`
`,d=`/`,f=`*`,p=``,m=`comment`,h=`declaration`;function g(e,t){if(typeof e!=`string`)throw TypeError(`First argument must be a string`);if(!e)return[];t||={};var l=1,g=1;function v(e){var t=e.match(r);t&&(l+=t.length);var n=e.lastIndexOf(u);g=~n?e.length-n:g+e.length}function y(){var e={line:l,column:g};return function(t){return t.position=new b(e),S(),t}}function b(e){this.start=e,this.end={line:l,column:g},this.source=t.source}b.prototype.content=e;function x(n){var r=Error(t.source+`:`+l+`:`+g+`: `+n);if(r.reason=n,r.filename=t.source,r.line=l,r.column=g,r.source=e,!t.silent)throw r}function ee(t){var n=t.exec(e);if(n){var r=n[0];return v(r),e=e.slice(r.length),n}}function S(){ee(i)}function C(e){var t;for(e||=[];t=te();)t!==!1&&e.push(t);return e}function te(){var t=y();if(!(d!=e.charAt(0)||f!=e.charAt(1))){for(var n=2;p!=e.charAt(n)&&(f!=e.charAt(n)||d!=e.charAt(n+1));)++n;if(n+=2,p===e.charAt(n-1))return x(`End of comment missing`);var r=e.slice(2,n-2);return g+=2,v(r),e=e.slice(n),g+=2,t({type:m,comment:r})}}function ne(){var e=y(),t=ee(a);if(t){if(te(),!ee(o))return x(`property missing ':'`);var r=ee(s),i=e({type:h,property:_(t[0].replace(n,p)),value:r?_(r[0].replace(n,p)):p});return ee(c),i}}function re(){var e=[];C(e);for(var t;t=ne();)t!==!1&&(e.push(t),C(e));return e}return S(),re()}function _(e){return e?e.replace(l,p):p}t.exports=g})),wt=t((e=>{var t=e&&e.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(e,`__esModule`,{value:!0}),e.default=r;var n=t(Ct());function r(e,t){let r=null;if(!e||typeof e!=`string`)return r;let i=(0,n.default)(e),a=typeof t==`function`;return i.forEach(e=>{if(e.type!==`declaration`)return;let{property:n,value:i}=e;a?t(n,i,e):i&&(r||={},r[n]=i)}),r}})),Tt=t((e=>{Object.defineProperty(e,`__esModule`,{value:!0}),e.camelCase=void 0;var t=/^--[a-zA-Z0-9_-]+$/,n=/-([a-z])/g,r=/^[^-]+$/,i=/^-(webkit|moz|ms|o|khtml)-/,a=/^-(ms)-/,o=function(e){return!e||r.test(e)||t.test(e)},s=function(e,t){return t.toUpperCase()},c=function(e,t){return`${t}-`};e.camelCase=function(e,t){return t===void 0&&(t={}),o(e)?e:(e=e.toLowerCase(),e=t.reactCompat?e.replace(a,c):e.replace(i,c),e.replace(n,s))}})),Et=t(((e,t)=>{var n=(e&&e.__importDefault||function(e){return e&&e.__esModule?e:{default:e}})(wt()),r=Tt();function i(e,t){var i={};return!e||typeof e!=`string`||(0,n.default)(e,function(e,n){e&&n&&(i[(0,r.camelCase)(e,t)]=n)}),i}i.default=i,t.exports=i})),Dt=class extends Error{constructor(e,t,n){super(),typeof t==`string`&&(n=t,t=void 0);let r=``,i={},a=!1;if(t&&(i=`line`in t&&`column`in t||`start`in t&&`end`in t?{place:t}:`type`in t?{ancestors:[t],place:t.position}:{...t}),typeof e==`string`?r=e:!i.cause&&e&&(a=!0,r=e.message,i.cause=e),!i.ruleId&&!i.source&&typeof n==`string`){let e=n.indexOf(`:`);e===-1?i.ruleId=n:(i.source=n.slice(0,e),i.ruleId=n.slice(e+1))}if(!i.place&&i.ancestors&&i.ancestors){let e=i.ancestors[i.ancestors.length-1];e&&(i.place=e.position)}let o=i.place&&`start`in i.place?i.place.start:i.place;this.ancestors=i.ancestors||void 0,this.cause=i.cause||void 0,this.column=o?o.column:void 0,this.fatal=void 0,this.file=``,this.message=r,this.line=o?o.line:void 0,this.name=d(i.place)||`1:1`,this.place=i.place||void 0,this.reason=this.message,this.ruleId=i.ruleId||void 0,this.source=i.source||void 0,this.stack=a&&i.cause&&typeof i.cause.stack==`string`?i.cause.stack:``,this.actual=void 0,this.expected=void 0,this.note=void 0,this.url=void 0}};Dt.prototype.file=``,Dt.prototype.name=``,Dt.prototype.reason=``,Dt.prototype.message=``,Dt.prototype.stack=``,Dt.prototype.column=void 0,Dt.prototype.line=void 0,Dt.prototype.ancestors=void 0,Dt.prototype.cause=void 0,Dt.prototype.fatal=void 0,Dt.prototype.place=void 0,Dt.prototype.ruleId=void 0,Dt.prototype.source=void 0;var Ot=e(Et(),1),kt={}.hasOwnProperty,At=new Map,jt=/[A-Z]/g,Mt=new Set([`table`,`tbody`,`thead`,`tfoot`,`tr`]),Nt=new Set([`td`,`th`]),Pt=`https://github.com/syntax-tree/hast-util-to-jsx-runtime`;function Ft(e,t){if(!t||t.Fragment===void 0)throw TypeError("Expected `Fragment` in options");let n=t.filePath||void 0,r;if(t.development){if(typeof t.jsxDEV!=`function`)throw TypeError("Expected `jsxDEV` in options when `development: true`");r=Kt(n,t.jsxDEV)}else{if(typeof t.jsx!=`function`)throw TypeError("Expected `jsx` in production options");if(typeof t.jsxs!=`function`)throw TypeError("Expected `jsxs` in production options");r=Gt(n,t.jsx,t.jsxs)}let a={Fragment:t.Fragment,ancestors:[],components:t.components||{},create:r,elementAttributeNameCase:t.elementAttributeNameCase||`react`,evaluater:t.createEvaluater?t.createEvaluater():void 0,filePath:n,ignoreInvalidStyle:t.ignoreInvalidStyle||!1,passKeys:t.passKeys!==!1,passNode:t.passNode||!1,schema:t.space===`svg`?c:i,stylePropertyNameCase:t.stylePropertyNameCase||`dom`,tableCellAlignToStyle:t.tableCellAlignToStyle!==!1},o=It(a,e,void 0);return o&&typeof o!=`string`?o:a.create(e,a.Fragment,{children:o||void 0},void 0)}function It(e,t,n){if(t.type===`element`)return Lt(e,t,n);if(t.type===`mdxFlowExpression`||t.type===`mdxTextExpression`)return Rt(e,t);if(t.type===`mdxJsxFlowElement`||t.type===`mdxJsxTextElement`)return Bt(e,t,n);if(t.type===`mdxjsEsm`)return zt(e,t);if(t.type===`root`)return Vt(e,t,n);if(t.type===`text`)return Ht(e,t)}function Lt(e,t,n){let r=e.schema,i=r;t.tagName.toLowerCase()===`svg`&&r.space===`html`&&(i=c,e.schema=i),e.ancestors.push(t);let a=Qt(e,t.tagName,!1),o=qt(e,t),s=Yt(e,t);return Mt.has(t.tagName)&&(s=s.filter(function(e){return typeof e==`string`?!xt(e):!0})),Ut(e,o,a,t),Wt(o,s),e.ancestors.pop(),e.schema=r,e.create(t,a,o,n)}function Rt(e,t){if(t.data&&t.data.estree&&e.evaluater){let n=t.data.estree.body[0];return n.type,e.evaluater.evaluateExpression(n.expression)}$t(e,t.position)}function zt(e,t){if(t.data&&t.data.estree&&e.evaluater)return e.evaluater.evaluateProgram(t.data.estree);$t(e,t.position)}function Bt(e,t,n){let r=e.schema,i=r;t.name===`svg`&&r.space===`html`&&(i=c,e.schema=i),e.ancestors.push(t);let a=t.name===null?e.Fragment:Qt(e,t.name,!0),o=Jt(e,t),s=Yt(e,t);return Ut(e,o,a,t),Wt(o,s),e.ancestors.pop(),e.schema=r,e.create(t,a,o,n)}function Vt(e,t,n){let r={};return Wt(r,Yt(e,t)),e.create(t,e.Fragment,r,n)}function Ht(e,t){return t.value}function Ut(e,t,n,r){typeof n!=`string`&&n!==e.Fragment&&e.passNode&&(t.node=r)}function Wt(e,t){if(t.length>0){let n=t.length>1?t:t[0];n&&(e.children=n)}}function Gt(e,t,n){return r;function r(e,r,i,a){let o=Array.isArray(i.children)?n:t;return a?o(r,i,a):o(r,i)}}function Kt(e,t){return n;function n(n,i,a,o){let s=Array.isArray(a.children),c=r(n);return t(i,a,o,s,{columnNumber:c?c.column-1:void 0,fileName:e,lineNumber:c?c.line:void 0},void 0)}}function qt(e,t){let n={},r,i;for(i in t.properties)if(i!==`children`&&kt.call(t.properties,i)){let a=Xt(e,i,t.properties[i]);if(a){let[i,o]=a;e.tableCellAlignToStyle&&i===`align`&&typeof o==`string`&&Nt.has(t.tagName)?r=o:n[i]=o}}if(r){let t=n.style||={};t[e.stylePropertyNameCase===`css`?`text-align`:`textAlign`]=r}return n}function Jt(e,t){let n={};for(let r of t.attributes)if(r.type===`mdxJsxExpressionAttribute`)if(r.data&&r.data.estree&&e.evaluater){let t=r.data.estree.body[0];t.type;let i=t.expression;i.type;let a=i.properties[0];a.type,Object.assign(n,e.evaluater.evaluateExpression(a.argument))}else $t(e,t.position);else{let i=r.name,a;if(r.value&&typeof r.value==`object`)if(r.value.data&&r.value.data.estree&&e.evaluater){let t=r.value.data.estree.body[0];t.type,a=e.evaluater.evaluateExpression(t.expression)}else $t(e,t.position);else a=r.value===null?!0:r.value;n[i]=a}return n}function Yt(e,t){let n=[],r=-1,i=e.passKeys?new Map:At;for(;++r<t.children.length;){let a=t.children[r],o;if(e.passKeys){let e=a.type===`element`?a.tagName:a.type===`mdxJsxFlowElement`||a.type===`mdxJsxTextElement`?a.name:void 0;if(e){let t=i.get(e)||0;o=e+`-`+t,i.set(e,t+1)}}let s=It(e,a,o);s!==void 0&&n.push(s)}return n}function Xt(e,t,n){let r=m(e.schema,t);if(!(n==null||typeof n==`number`&&Number.isNaN(n))){if(Array.isArray(n)&&(n=r.commaSeparated?f(n):u(n)),r.property===`style`){let t=typeof n==`object`?n:Zt(e,String(n));return e.stylePropertyNameCase===`css`&&(t=en(t)),[`style`,t]}return[e.elementAttributeNameCase===`react`&&r.space?a[r.property]||r.property:r.attribute,n]}}function Zt(e,t){try{return(0,Ot.default)(t,{reactCompat:!0})}catch(t){if(e.ignoreInvalidStyle)return{};let n=t,r=new Dt("Cannot parse `style` attribute",{ancestors:e.ancestors,cause:n,ruleId:`style`,source:`hast-util-to-jsx-runtime`});throw r.file=e.filePath||void 0,r.url=Pt+`#cannot-parse-style-attribute`,r}}function Qt(e,t,n){let r;if(!n)r={type:`Literal`,value:t};else if(t.includes(`.`)){let e=t.split(`.`),n=-1,i;for(;++n<e.length;){let t=yt(e[n])?{type:`Identifier`,name:e[n]}:{type:`Literal`,value:e[n]};i=i?{type:`MemberExpression`,object:i,property:t,computed:!!(n&&t.type===`Literal`),optional:!1}:t}r=i}else r=yt(t)&&!/^[a-z]/.test(t)?{type:`Identifier`,name:t}:{type:`Literal`,value:t};if(r.type===`Literal`){let t=r.value;return kt.call(e.components,t)?e.components[t]:t}if(e.evaluater)return e.evaluater.evaluateExpression(r);$t(e)}function $t(e,t){let n=new Dt("Cannot handle MDX estrees without `createEvaluater`",{ancestors:e.ancestors,place:t,ruleId:`mdx-estree`,source:`hast-util-to-jsx-runtime`});throw n.file=e.filePath||void 0,n.url=Pt+`#cannot-handle-mdx-estrees-without-createevaluater`,n}function en(e){let t={},n;for(n in e)kt.call(e,n)&&(t[tn(n)]=e[n]);return t}function tn(e){let t=e.replace(jt,nn);return t.slice(0,3)===`ms-`&&(t=`-`+t),t}function nn(e){return`-`+e.toLowerCase()}const rn={action:[`form`],cite:[`blockquote`,`del`,`ins`,`q`],data:[`object`],formAction:[`button`,`input`],href:[`a`,`area`,`base`,`link`],icon:[`menuitem`],itemId:null,manifest:[`html`],ping:[`a`,`area`],poster:[`video`],src:[`audio`,`embed`,`iframe`,`img`,`input`,`script`,`source`,`track`,`video`]};function an(e){if(e)throw e}var on=t(((e,t)=>{var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=Object.defineProperty,a=Object.getOwnPropertyDescriptor,o=function(e){return typeof Array.isArray==`function`?Array.isArray(e):r.call(e)===`[object Array]`},s=function(e){if(!e||r.call(e)!==`[object Object]`)return!1;var t=n.call(e,`constructor`),i=e.constructor&&e.constructor.prototype&&n.call(e.constructor.prototype,`isPrototypeOf`);if(e.constructor&&!t&&!i)return!1;for(var a in e);return a===void 0||n.call(e,a)},c=function(e,t){i&&t.name===`__proto__`?i(e,t.name,{enumerable:!0,configurable:!0,value:t.newValue,writable:!0}):e[t.name]=t.newValue},l=function(e,t){if(t===`__proto__`)if(n.call(e,t)){if(a)return a(e,t).value}else return;return e[t]};t.exports=function e(){var t,n,r,i,a,u,d=arguments[0],f=1,p=arguments.length,m=!1;for(typeof d==`boolean`&&(m=d,d=arguments[1]||{},f=2),(d==null||typeof d!=`object`&&typeof d!=`function`)&&(d={});f<p;++f)if(t=arguments[f],t!=null)for(n in t)r=l(d,n),i=l(t,n),d!==i&&(m&&i&&(s(i)||(a=o(i)))?(a?(a=!1,u=r&&o(r)?r:[]):u=r&&s(r)?r:{},c(d,{name:n,newValue:e(m,u,i)})):i!==void 0&&c(d,{name:n,newValue:i}));return d}}));function sn(e){if(typeof e!=`object`||!e)return!1;let t=Object.getPrototypeOf(e);return(t===null||t===Object.prototype||Object.getPrototypeOf(t)===null)&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)}function cn(){let e=[],t={run:n,use:r};return t;function n(...t){let n=-1,r=t.pop();if(typeof r!=`function`)throw TypeError(`Expected function as last argument, not `+r);i(null,...t);function i(a,...o){let s=e[++n],c=-1;if(a){r(a);return}for(;++c<t.length;)(o[c]===null||o[c]===void 0)&&(o[c]=t[c]);t=o,s?ln(s,i)(...o):r(null,...o)}}function r(n){if(typeof n!=`function`)throw TypeError("Expected `middelware` to be a function, not "+n);return e.push(n),t}}function ln(e,t){let n;return r;function r(...t){let r=e.length>t.length,o;r&&t.push(i);try{o=e.apply(this,t)}catch(e){let t=e;if(r&&n)throw t;return i(t)}r||(o&&o.then&&typeof o.then==`function`?o.then(a,i):o instanceof Error?i(o):a(o))}function i(e,...r){n||(n=!0,t(e,...r))}function a(e){i(null,e)}}const un={basename:dn,dirname:fn,extname:pn,join:mn,sep:`/`};function dn(e,t){if(t!==void 0&&typeof t!=`string`)throw TypeError(`"ext" argument must be a string`);_n(e);let n=0,r=-1,i=e.length,a;if(t===void 0||t.length===0||t.length>e.length){for(;i--;)if(e.codePointAt(i)===47){if(a){n=i+1;break}}else r<0&&(a=!0,r=i+1);return r<0?``:e.slice(n,r)}if(t===e)return``;let o=-1,s=t.length-1;for(;i--;)if(e.codePointAt(i)===47){if(a){n=i+1;break}}else o<0&&(a=!0,o=i+1),s>-1&&(e.codePointAt(i)===t.codePointAt(s--)?s<0&&(r=i):(s=-1,r=o));return n===r?r=o:r<0&&(r=e.length),e.slice(n,r)}function fn(e){if(_n(e),e.length===0)return`.`;let t=-1,n=e.length,r;for(;--n;)if(e.codePointAt(n)===47){if(r){t=n;break}}else r||=!0;return t<0?e.codePointAt(0)===47?`/`:`.`:t===1&&e.codePointAt(0)===47?`//`:e.slice(0,t)}function pn(e){_n(e);let t=e.length,n=-1,r=0,i=-1,a=0,o;for(;t--;){let s=e.codePointAt(t);if(s===47){if(o){r=t+1;break}continue}n<0&&(o=!0,n=t+1),s===46?i<0?i=t:a!==1&&(a=1):i>-1&&(a=-1)}return i<0||n<0||a===0||a===1&&i===n-1&&i===r+1?``:e.slice(i,n)}function mn(...e){let t=-1,n;for(;++t<e.length;)_n(e[t]),e[t]&&(n=n===void 0?e[t]:n+`/`+e[t]);return n===void 0?`.`:hn(n)}function hn(e){_n(e);let t=e.codePointAt(0)===47,n=gn(e,!t);return n.length===0&&!t&&(n=`.`),n.length>0&&e.codePointAt(e.length-1)===47&&(n+=`/`),t?`/`+n:n}function gn(e,t){let n=``,r=0,i=-1,a=0,o=-1,s,c;for(;++o<=e.length;){if(o<e.length)s=e.codePointAt(o);else if(s===47)break;else s=47;if(s===47){if(!(i===o-1||a===1))if(i!==o-1&&a===2){if(n.length<2||r!==2||n.codePointAt(n.length-1)!==46||n.codePointAt(n.length-2)!==46){if(n.length>2){if(c=n.lastIndexOf(`/`),c!==n.length-1){c<0?(n=``,r=0):(n=n.slice(0,c),r=n.length-1-n.lastIndexOf(`/`)),i=o,a=0;continue}}else if(n.length>0){n=``,r=0,i=o,a=0;continue}}t&&(n=n.length>0?n+`/..`:`..`,r=2)}else n.length>0?n+=`/`+e.slice(i+1,o):n=e.slice(i+1,o),r=o-i-1;i=o,a=0}else s===46&&a>-1?a++:a=-1}return n}function _n(e){if(typeof e!=`string`)throw TypeError(`Path must be a string. Received `+JSON.stringify(e))}const vn={cwd:yn};function yn(){return`/`}function bn(e){return!!(typeof e==`object`&&e&&`href`in e&&e.href&&`protocol`in e&&e.protocol&&e.auth===void 0)}function xn(e){if(typeof e==`string`)e=new URL(e);else if(!bn(e)){let t=TypeError('The "path" argument must be of type string or an instance of URL. Received `'+e+"`");throw t.code=`ERR_INVALID_ARG_TYPE`,t}if(e.protocol!==`file:`){let e=TypeError(`The URL must be of scheme file`);throw e.code=`ERR_INVALID_URL_SCHEME`,e}return Sn(e)}function Sn(e){if(e.hostname!==``){let e=TypeError(`File URL host must be "localhost" or empty on darwin`);throw e.code=`ERR_INVALID_FILE_URL_HOST`,e}let t=e.pathname,n=-1;for(;++n<t.length;)if(t.codePointAt(n)===37&&t.codePointAt(n+1)===50){let e=t.codePointAt(n+2);if(e===70||e===102){let e=TypeError(`File URL path must not include encoded / characters`);throw e.code=`ERR_INVALID_FILE_URL_PATH`,e}}return decodeURIComponent(t)}var Cn=[`history`,`path`,`basename`,`stem`,`extname`,`dirname`],wn=class{constructor(e){let t;t=e?bn(e)?{path:e}:typeof e==`string`||On(e)?{value:e}:e:{},this.cwd=`cwd`in t?``:vn.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let n=-1;for(;++n<Cn.length;){let e=Cn[n];e in t&&t[e]!==void 0&&t[e]!==null&&(this[e]=e===`history`?[...t[e]]:t[e])}let r;for(r in t)Cn.includes(r)||(this[r]=t[r])}get basename(){return typeof this.path==`string`?un.basename(this.path):void 0}set basename(e){En(e,`basename`),Tn(e,`basename`),this.path=un.join(this.dirname||``,e)}get dirname(){return typeof this.path==`string`?un.dirname(this.path):void 0}set dirname(e){Dn(this.basename,`dirname`),this.path=un.join(e||``,this.basename)}get extname(){return typeof this.path==`string`?un.extname(this.path):void 0}set extname(e){if(Tn(e,`extname`),Dn(this.dirname,`extname`),e){if(e.codePointAt(0)!==46)throw Error("`extname` must start with `.`");if(e.includes(`.`,1))throw Error("`extname` cannot contain multiple dots")}this.path=un.join(this.dirname,this.stem+(e||``))}get path(){return this.history[this.history.length-1]}set path(e){bn(e)&&(e=xn(e)),En(e,`path`),this.path!==e&&this.history.push(e)}get stem(){return typeof this.path==`string`?un.basename(this.path,this.extname):void 0}set stem(e){En(e,`stem`),Tn(e,`stem`),this.path=un.join(this.dirname||``,e+(this.extname||``))}fail(e,t,n){let r=this.message(e,t,n);throw r.fatal=!0,r}info(e,t,n){let r=this.message(e,t,n);return r.fatal=void 0,r}message(e,t,n){let r=new Dt(e,t,n);return this.path&&(r.name=this.path+`:`+r.name,r.file=this.path),r.fatal=!1,this.messages.push(r),r}toString(e){return this.value===void 0?``:typeof this.value==`string`?this.value:new TextDecoder(e||void 0).decode(this.value)}};function Tn(e,t){if(e&&e.includes(un.sep))throw Error("`"+t+"` cannot be a path: did not expect `"+un.sep+"`")}function En(e,t){if(!e)throw Error("`"+t+"` cannot be empty")}function Dn(e,t){if(!e)throw Error("Setting `"+t+"` requires `path` to be set too")}function On(e){return!!(e&&typeof e==`object`&&`byteLength`in e&&`byteOffset`in e)}const kn=(function(e){let t=this.constructor.prototype,n=t[e],r=function(){return n.apply(r,arguments)};return Object.setPrototypeOf(r,t),r});var An=e(on(),1),jn={}.hasOwnProperty;const Mn=new class e extends kn{constructor(){super(`copy`),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=cn()}copy(){let t=new e,n=-1;for(;++n<this.attachers.length;){let e=this.attachers[n];t.use(...e)}return t.data((0,An.default)(!0,{},this.namespace)),t}data(e,t){return typeof e==`string`?arguments.length===2?(Fn(`data`,this.frozen),this.namespace[e]=t,this):jn.call(this.namespace,e)&&this.namespace[e]||void 0:e?(Fn(`data`,this.frozen),this.namespace=e,this):this.namespace}freeze(){if(this.frozen)return this;let e=this;for(;++this.freezeIndex<this.attachers.length;){let[t,...n]=this.attachers[this.freezeIndex];if(n[0]===!1)continue;n[0]===!0&&(n[0]=void 0);let r=t.call(e,...n);typeof r==`function`&&this.transformers.use(r)}return this.frozen=!0,this.freezeIndex=1/0,this}parse(e){this.freeze();let t=Rn(e),n=this.parser||this.Parser;return Nn(`parse`,n),n(String(t),t)}process(e,t){let n=this;return this.freeze(),Nn(`process`,this.parser||this.Parser),Pn(`process`,this.compiler||this.Compiler),t?r(void 0,t):new Promise(r);function r(r,i){let a=Rn(e),o=n.parse(a);n.run(o,a,function(e,t,r){if(e||!t||!r)return s(e);let i=t,a=n.stringify(i,r);Bn(a)?r.value=a:r.result=a,s(e,r)});function s(e,n){e||!n?i(e):r?r(n):t(void 0,n)}}}processSync(e){let t=!1,n;return this.freeze(),Nn(`processSync`,this.parser||this.Parser),Pn(`processSync`,this.compiler||this.Compiler),this.process(e,r),Ln(`processSync`,`process`,t),n;function r(e,r){t=!0,an(e),n=r}}run(e,t,n){In(e),this.freeze();let r=this.transformers;return!n&&typeof t==`function`&&(n=t,t=void 0),n?i(void 0,n):new Promise(i);function i(i,a){let o=Rn(t);r.run(e,o,s);function s(t,r,o){let s=r||e;t?a(t):i?i(s):n(void 0,s,o)}}}runSync(e,t){let n=!1,r;return this.run(e,t,i),Ln(`runSync`,`run`,n),r;function i(e,t){an(e),r=t,n=!0}}stringify(e,t){this.freeze();let n=Rn(t),r=this.compiler||this.Compiler;return Pn(`stringify`,r),In(e),r(e,n)}use(e,...t){let n=this.attachers,r=this.namespace;if(Fn(`use`,this.frozen),e!=null)if(typeof e==`function`)s(e,t);else if(typeof e==`object`)Array.isArray(e)?o(e):a(e);else throw TypeError("Expected usable value, not `"+e+"`");return this;function i(e){if(typeof e==`function`)s(e,[]);else if(typeof e==`object`)if(Array.isArray(e)){let[t,...n]=e;s(t,n)}else a(e);else throw TypeError("Expected usable value, not `"+e+"`")}function a(e){if(!(`plugins`in e)&&!(`settings`in e))throw Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");o(e.plugins),e.settings&&(r.settings=(0,An.default)(!0,r.settings,e.settings))}function o(e){let t=-1;if(e!=null)if(Array.isArray(e))for(;++t<e.length;){let n=e[t];i(n)}else throw TypeError("Expected a list of plugins, not `"+e+"`")}function s(e,t){let r=-1,i=-1;for(;++r<n.length;)if(n[r][0]===e){i=r;break}if(i===-1)n.push([e,...t]);else if(t.length>0){let[r,...a]=t,o=n[i][1];sn(o)&&sn(r)&&(r=(0,An.default)(!0,o,r)),n[i]=[e,r,...a]}}}}().freeze();function Nn(e,t){if(typeof t!=`function`)throw TypeError("Cannot `"+e+"` without `parser`")}function Pn(e,t){if(typeof t!=`function`)throw TypeError("Cannot `"+e+"` without `compiler`")}function Fn(e,t){if(t)throw Error("Cannot call `"+e+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function In(e){if(!sn(e)||typeof e.type!=`string`)throw TypeError("Expected node, got `"+e+"`")}function Ln(e,t,n){if(!n)throw Error("`"+e+"` finished async. Use `"+t+"` instead")}function Rn(e){return zn(e)?e:new wn(e)}function zn(e){return!!(e&&typeof e==`object`&&`message`in e&&`messages`in e)}function Bn(e){return typeof e==`string`||Vn(e)}function Vn(e){return!!(e&&typeof e==`object`&&`byteLength`in e&&`byteOffset`in e)}var Hn=e(C(),1),Un=[],Wn={allowDangerousHtml:!0},Gn=/^(https?|ircs?|mailto|xmpp)$/i,Kn=[{from:`astPlugins`,id:`remove-buggy-html-in-markdown-parser`},{from:`allowDangerousHtml`,id:`remove-buggy-html-in-markdown-parser`},{from:`allowNode`,id:`replace-allownode-allowedtypes-and-disallowedtypes`,to:`allowElement`},{from:`allowedTypes`,id:`replace-allownode-allowedtypes-and-disallowedtypes`,to:`allowedElements`},{from:`className`,id:`remove-classname`},{from:`disallowedTypes`,id:`replace-allownode-allowedtypes-and-disallowedtypes`,to:`disallowedElements`},{from:`escapeHtml`,id:`remove-buggy-html-in-markdown-parser`},{from:`includeElementIndex`,id:`#remove-includeelementindex`},{from:`includeNodeIndex`,id:`change-includenodeindex-to-includeelementindex`},{from:`linkTarget`,id:`remove-linktarget`},{from:`plugins`,id:`change-plugins-to-remarkplugins`,to:`remarkPlugins`},{from:`rawSourcePos`,id:`#remove-rawsourcepos`},{from:`renderers`,id:`change-renderers-to-components`,to:`components`},{from:`source`,id:`change-source-to-children`,to:`children`},{from:`sourcePos`,id:`#remove-sourcepos`},{from:`transformImageUri`,id:`#add-urltransform`,to:`urlTransform`},{from:`transformLinkUri`,id:`#add-urltransform`,to:`urlTransform`}];function qn(e){let t=Xn(e),n=Zn(e);return Qn(t.runSync(t.parse(n),n),e)}async function Jn(e){let t=Xn(e),n=Zn(e);return Qn(await t.run(t.parse(n),n),e)}function Yn(e){let t=Xn(e),[n,r]=(0,k.useState)(void 0),[i,a]=(0,k.useState)(void 0);if((0,k.useEffect)(function(){let n=!1,i=Zn(e);return t.run(t.parse(i),i,function(e,t){n||(r(e),a(t))}),function(){n=!0}},[e.children,e.rehypePlugins,e.remarkPlugins,e.remarkRehypeOptions]),n)throw n;return i?Qn(i,e):e.fallback}function Xn(e){let t=e.rehypePlugins||Un,n=e.remarkPlugins||Un,r=e.remarkRehypeOptions?{...e.remarkRehypeOptions,...Wn}:Wn;return Mn().use(l).use(n).use(p,r).use(t)}function Zn(e){let t=e.children||``,n=new wn;return typeof t==`string`?n.value=t:``+t,n}function Qn(e,t){let n=t.allowedElements,r=t.allowElement,i=t.components,a=t.disallowedElements,o=t.skipHtml,c=t.unwrapDisallowed,l=t.urlTransform||$n;for(let e of Kn)Object.hasOwn(t,e.from)&&``+e.from+(e.to?"use `"+e.to+"` instead":`remove it`)+e.id;return s(e,u),Ft(e,{Fragment:Hn.Fragment,components:i,ignoreInvalidStyle:!0,jsx:Hn.jsx,jsxs:Hn.jsxs,passKeys:!0,passNode:!0});function u(e,t,i){if(e.type===`raw`&&i&&typeof t==`number`)return o?i.children.splice(t,1):i.children[t]={type:`text`,value:e.value},t;if(e.type===`element`){let t;for(t in rn)if(Object.hasOwn(rn,t)&&Object.hasOwn(e.properties,t)){let n=e.properties[t],r=rn[t];(r===null||r.includes(e.tagName))&&(e.properties[t]=l(String(n||``),t,e))}}if(e.type===`element`){let o=n?!n.includes(e.tagName):a?a.includes(e.tagName):!1;if(!o&&r&&typeof t==`number`&&(o=!r(e,t,i)),o&&i&&typeof t==`number`)return c&&e.children?i.children.splice(t,1,...e.children):i.children.splice(t,1),t}}}function $n(e){let t=e.indexOf(`:`),n=e.indexOf(`?`),r=e.indexOf(`#`),i=e.indexOf(`/`);return t===-1||i!==-1&&t>i||n!==-1&&t>n||r!==-1&&t>r||Gn.test(e.slice(0,t))?e:``}export{C as _,mt as a,le as c,oe as d,ae as f,te as g,ne as h,$n as i,ce as l,re as m,Jn as n,ht as o,ie as p,Yn as r,ue as s,qn as t,se as u,ee as v,g as y};